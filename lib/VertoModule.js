    ...
    (function($) {
        ...
        $.FSRTC.prototype.createAnswer = function(params) {
            ...
            getUserMedia({
				...
				video: mediaParams.useVideo || false,
        ...
        function getMediaParams(obj) {
            ...
            if (useVideo && obj.options.useCamera && obj.options.useCamera !== "none") {
                ...
                video = false; // TODO merge error
                useVideo = false; // TODO merge error
            }
	...
	(function($) {
		...
		$.verto.enum.states = Object.freeze({
			...
			new: {
				...
				recovering: 1,
				ringing: 1,
				destroy: 1,answering: 1,hangup: 1},requesting: {trying: 1,hangup: 1},recovering: {answering: 1,hangup: 1},trying: {active: 1,early: 1,hangup: 1},ringing: {answering: 1,hangup: 1},answering: {active: 1,hangup: 1},active: {answering: 1,requesting: 1,hangup: 1,held: 1},held: {hangup: 1,active: 1},early: {hangup: 1,active: 1},hangup: {destroy: 1},destroy: {},purge: {destroy: 1}});
