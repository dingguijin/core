define('WebitelVerto', [], function() {
    ...
    (function($) {
        ...
        $.FSRTC.prototype.setMuteVideo = function(what) {
            var self = this;
    ...
    (function($) {
        ...
        $.verto.dialog.prototype.setMuteVideo = function(what) {
            var dialog = this;
            return dialog.rtc.setMuteVideo(what);
        };
