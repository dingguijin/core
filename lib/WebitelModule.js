...
//            AccountRole: 'ACCOUNT_ROLE',
        ...
        var WebitelCall = function(key, channel, state) {
            ...
            this.getCalleeNumber = function () {
                ...
                if (callerCallee) {
                    callerCallee = callerCallee.split('@')[0];
                };
                if (callerCaller) {
                    callerCaller = callerCaller.split('@')[0];
                };
        ...
        var webrtcPhoneStart = function (option) {
            ...
            var callbacks = {
                ...
                onGetVideoContainer: function (d) {
                    OnNewWebRTCCall.trigger(d);
                },
            ...
            webrtcPhone = new WebitelVerto({
                ...
                ringFileTag: jssipConfiguration['ringFileTag'],
                ...
                //screenShare: true,
                useStereo: jssipConfiguration['useStereo'],
...
//                    that._status = ConnectionStatus.Disconnected;
            ...
            login: function(handle) {
                var that = this,
                    ...
                    OnWebitelLogin.trigger(that.getCurrentStatus());
                });
                ;
                login.execute();
            },
        ...
        var resultInterface = {
             ...
             * CC
             */
            loginCallCenter: Function,
            logoutCallCenter: Function,
