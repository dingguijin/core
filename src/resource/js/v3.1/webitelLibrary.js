...
//        OnHook: '"ONHOOK"'
        ...
        return Webitel = function(parameters) {
            ...
            if (webrtc) {
                try {
                    ...
                    // TODO
                    webrtc_domain = domainUser = (domainUser || getHostName(location.hostname));
                } catch (e) {
                    console.error(e);
                }
            }
...
//            AccountRole: 'ACCOUNT_ROLE',
            ...
            var WebitelUser = function(attrs) {
                ...
                this.setStatus = function(away, state, tag) {
                    attrs['away'] = away;
                    attrs['state'] = state;
                    attrs['tag'] = tag || '';
                    OnWebitelUserStatusChange.trigger(that.getJSONObject());
                ...
                switch (attrs['Event-Name']) {
                    ...
                    case WebitelUserEventTypes.AccountStatus:
                        ...
                        if (user) {
                            ...
                            user.setStatus(attrs['Account-Status'], attrs['Account-User-State'], attrs['Account-Status-Descript']);
                        }
                        break;
